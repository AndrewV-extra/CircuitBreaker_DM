...
st.markdown(
    """
Both forms of DM are widely prevalent globally. Until the Pandemic, the prevalence of both mostly stayed the same (increasing and decreasing slightly year by year), but spiked drastically during the Pandemic. Diabetes Type-2 is caused and affected by lifestyle choices such as healthy food and exercise. The Circuit - Breaker / Lockdown measures made during the pandemic significantly restricted people's access to the outdoors, forcing them to stay at home, leading to a more sedentary lifestyle. Furthermore, the pressure placed upon healthcare systems by the pandemic often made medication less accessible. Both forms of diabetes require long-term treatment, and a disrupted healthcare system could cause disruptions in the level of care provided to diabetes patients. There is significant clinical data that Covid-19 affects Diabetes patients in more acute ways. The widespread effects of Covid-19 on the healthcare system have also been widely documented.  The paper agreed that the pandemic had significant negative effects on DM patients, not just because of Covid - 19 having worse effects on DM patients, but also the circuit breaker policies.In summary, Singapore’s circuit breaker policies and Covid-19 negatively affected DM in Singapore, but the various programs run by the government were somewhat effective in counteracting this. If the government had invested more money into such programs, DM prevalence and death rates could probably have been reduced further, though such things are easy to say in retrospect, where resource conservation is less of a priority. 
    """
)
